...
| 7 Spikes | AG2 storage swap, definition pin, **Postgres concurrency**, **work-bundle generality**, **tool interception** — 5 spikes, **135 gate assertions**, verification rules |
